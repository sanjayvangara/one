...
<body>
	...
	<h1 style="color: pink; font-size: 40px;" align="center">WE ARE SUCCESSFY DEPLOYED APPLICATION</h1>
	<h1 style="color: red; font-size: 40px;" align="center">WE INTEGRATED NEXUS TO JENK</h1>
